...
/* TVP5150_LUMA_PROC_CTL_2 definitions */
#define TVP5150_SHARPNESS_SHIFT		2
#define TVP5150_SHARPNESS_MASK		(3<<TVP5150_SHARPNESS_SHIFT)
#define TVP5150_LOCK_STATUS_MASK	(STATUS_HORZ_SYNC_LOCK_BIT | \
